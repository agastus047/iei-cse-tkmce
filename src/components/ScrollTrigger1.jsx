  ...
  return (
    <div className="bg-cyanblue p-4 md:p-8">
      <div className="flex md:flex-row justify-between md:gap-24 mt-20 ">
        ...
        <div className="font-Poppins font-bold md:text-6xl sm:text-4xl text-xl text-white md:text-right">
          WHO ARE WE?
        </div>
      </div>
      <div className="text-white md:text-2xl text-sm font-Poppins mt-4 md:mt-6 md:text-right mb-20">
