  ...
  return (
    <div className='flex-col justify-start '>
      <div className='flex justify-between md:gap-10 lg:gap-5 gap-5 items-center  mr-0 pt-4 pb-4' style={{background:'#00ADB5'}}>
        <div className='flex-col font-Michroma ml-10 lg:ml-20 w-3/6 text-left' style={{background:'#00ADB5'}}>
        ...
        <div style={customBoxShadowStyle1} className='bg-#00ADB5 max-sm:p-2'>
        ...
        <div style={customBoxShadowStyle4} className='xl:w-350 xl:h-400  xl:right-40 lg:w-300 lg:h-350  lg:right-32  lg:mb-24 md:right-16 md:w-64 md:h-64  sm:right-16 sm:w-60 sm:h-60 min-[390px]:right-12 max-[640px]:right-12        w-28 h-28 mb-8' ></div>
        
        </div>

      <div className='flex justify-between items-centerlg:gap-20  pb-8 pt-8 lg:h-500 sm:h-400  ' style={{backgroundColor:'#393E46'}}>
      <div>
