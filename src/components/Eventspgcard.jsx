...
const Eventcard =({items})=>
{
    return(
        ...
        <div className="md:mt-5 w-64 md:w-72 bg-white lg:w-84 h-84 m-auto flex flex-col rounded-lg border-4 border-cyan-500  transform transition-transform hover:scale-105 ">
