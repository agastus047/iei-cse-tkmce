...
const Register = () => {
  ...
  return (
    <div className='flex p-2 border-4 shadow-lg font-Poppins w-full  gap-5'>
      <div className='md:w-4/12 flex flex-col gap-4 p-4 h-screen justify-center items-center min-h-screen -mb-20 xss:-mb-24 sm:-mb-28 xl:-mb-28  sticky  top-0'>
      ...
      <div className="w-8/12  ">
        <form className='flex flex-col justify-center items-center'>
          ...
          bg-white relative px-1 top-2  left-3 w-auto group-focus-within:text-red-600 ">
              ...
              <input type="text" name="first_name" id="first_name" className="h-10 text-[11px]text-10 w-3/4   border py-55-rem border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          ...
          bg-white relative px-1 top-2  left-3 w-auto group-focus-within:text-red-600 ">
              ...
              <input type="email" name="first_name" id="first_name" className="h-10 text-[11px]text-10   border py-55-rem border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-3/4  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                required="" placeholder="" />
            </div>
            <div className="relative z-0  px-2 w-full group">
              <label className="font-mono uppercase font-bold  text-11  text-gray-900 dark:text-gray-300
