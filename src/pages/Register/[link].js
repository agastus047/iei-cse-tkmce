...
const Register = () => {
  ...
  return (
    <div className='md:flex font-Poppins w-full  gap-5 '>
      ...
      bg-white relative px-1 top-2  left-3 w-auto group-focus-within:text-red-600 ">
            ...
            <div className="bg-cyan-500 hover:font-bold indicator rounded-md w-full p-4 mb-4 flex flex-col items-center justify-center shadow-xl">
              <span className="indicator-item indicator-center badge badge-info"></span>
              <label className="">Amount</label>
              <div className="bg-cyan-500 hover:font-bold bg-opacity-50 rounded w-3/4 grid text-center justify-center">
